...
static inline struct dma_buf *sram_heap_alloc_dma_buf_by_name(const char *name, size_t size)
{
	return NULL;
}
...
static inline struct page *sram_heap_alloc_pages_by_name(const char *name, size_t size)
{
	return NULL;
}

static inline void sram_heap_free_pages(struct page *p) {}
static inline void sram_heap_free_pages_by_name(const char *name, struct page *p) {}
