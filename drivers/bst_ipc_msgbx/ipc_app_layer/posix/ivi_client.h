...
struct _ivi_client_t {
	ivi_switch_client_t ivi_switch_client;
...
#define ivi_client_t struct _ivi_client_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _ivi_client_data_t {
	com_client_data_t com_data;
	ivi_client_t client;
	ivi_switch_client_ext_t ivi_switch_ext;
};
#define ivi_client_data_t struct _ivi_client_data_t
