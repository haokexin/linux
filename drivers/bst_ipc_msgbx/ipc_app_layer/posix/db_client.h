...
struct _db_client_t {
	db_switch_client_t db_switch_client;
...
#define db_client_t struct _db_client_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _db_client_data_t {
	com_client_data_t com_data;
	db_client_t client;
	db_switch_client_ext_t db_switch_ext;
};
#define db_client_data_t struct _db_client_data_t
