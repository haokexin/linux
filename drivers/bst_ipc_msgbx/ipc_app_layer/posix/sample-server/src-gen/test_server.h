...
extern "C"
{
	...
	typedef void (*test_complex_method_t)(const uint32_t in1, const char * in2, const byte_buffer in3, const test_MyArray_t in4, const test_MyStruct2_t in5, const test_MyUnion_t in6, uint32_t* out1, char ** out2, byte_buffer* out3, test_MyArray_t* out4, test_MyStruct2_t* out5, test_MyUnion_t* out6, test_ErrorEnum_t* err);
