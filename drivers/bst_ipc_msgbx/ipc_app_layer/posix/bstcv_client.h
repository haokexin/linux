...
// init server
bstcv_client *bstcv0_client_init(void);
bstcv_client *bstcv1_client_init(void);
bstcv_client *bstcv2_client_init(void);
bstcv_client *bstcv3_client_init(void);

// destroy client
int32_t bstcv0_client_destroy(void);
int32_t bstcv1_client_destroy(void);
int32_t bstcv2_client_destroy(void);
int32_t bstcv3_client_destroy(void);
