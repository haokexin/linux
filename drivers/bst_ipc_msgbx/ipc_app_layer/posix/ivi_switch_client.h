...
#ifndef IVI_SWITCH_CLIENT_H
#define IVI_SWITCH_CLIENT_H
 ...
 */
typedef void (*ivi_switch_vmac_method_callback_t)(
 ...
 * The data MAY CHANGED after leaving the callback function.
 */
typedef void (*ivi_switch_notify_vmac_reinit_callback_t)(
...
#define ivi_switch_client_t struct _ivi_switch_client_t

/**
 *  The extend data used by the client.
 */
struct _ivi_switch_client_ext_t {
	uint8_t cid;
	uint8_t ccid;
	uint8_t status;
	uint8_t res[5];
...
#define ivi_switch_client_ext_t struct _ivi_switch_client_ext_t

/**
 * Initializes the client.
 *
 * @param data The data for com_client_data_t
 * @param client The data for ivi_switch_client_t
 * @param ext The data for ivi_switch_client_ext_t
 * @return 0 if success, negative if fail.
 */
int32_t ivi_switch_client_init(com_client_data_t *data,
			ivi_switch_client_t *client,
