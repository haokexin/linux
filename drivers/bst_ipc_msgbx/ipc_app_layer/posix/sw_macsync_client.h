 ...
 * @param client The data for sw_macsync_client_t
 * @param ext The data for sw_macsync_client_ext_t
 * @return 0 if success, negative if fail.
 */
int32_t sw_macsync_client_init(com_client_data_t *data,
			sw_macsync_client_t *client,
