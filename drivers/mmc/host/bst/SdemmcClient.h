...
#ifndef SDEMMCCLIENT_H
#define SDEMMCCLIENT_H
...
struct _SdemmcClient_t {
	sdemmc_client_t sdemmc_client;
...
#define SdemmcClient_t struct _SdemmcClient_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _SdemmcClient_data_t {
	com_client_data_t com_data;
	SdemmcClient_t client;
	sdemmc_client_ext_t sdemmc_ext;
};
#define SdemmcClient_data_t struct _SdemmcClient_data_t
