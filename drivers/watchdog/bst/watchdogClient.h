...
struct _watchdogClient_t {
	watchdog_client_t watchdog_client;
...
#define watchdogClient_t struct _watchdogClient_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _watchdogClient_data_t {
	com_client_data_t com_data;
	watchdogClient_t client;
	watchdog_client_ext_t watchdog_ext;
};
#define watchdogClient_data_t struct _watchdogClient_data_t
