 ...
 */
typedef void (*watchdog_fusacoreip_method_callback_t)(
 ...
 * The data MAY CHANGED after leaving the callback function.
 */
typedef void (*watchdog_fusaenable_method_callback_t)(
...
#define watchdog_client_t struct _watchdog_client_t

/**
 *  The extend data used by the client.
 */
struct _watchdog_client_ext_t {
	uint8_t cid;
	uint8_t ccid;
	uint8_t status;
	uint8_t res[5];
...
#define watchdog_client_ext_t struct _watchdog_client_ext_t

/**
 * Initializes the client.
 *
 * @param data The data for com_client_data_t
 * @param client The data for watchdog_client_t
 * @param ext The data for watchdog_client_ext_t
 * @return 0 if success, negative if fail.
 */
int32_t watchdog_client_init(com_client_data_t *data,
