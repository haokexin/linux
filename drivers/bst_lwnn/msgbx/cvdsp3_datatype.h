...
#ifndef CVDSP3_DATATYPE_H
#define CVDSP3_DATATYPE_H
...
// user defined types
enum _cvdsp3_ErrorEnum_t {
	CVDSP3_NO_ERROR = 0,
	CVDSP3_SERVER_FAIL = -1,
	CVDSP3_ERROR_PARA = -2,
	CVDSP3_ERROR_SYS = -3
};
#define cvdsp3_ErrorEnum_t enum _cvdsp3_ErrorEnum_t
...
/**
 * Deserialize cvdsp3_ErrorEnum_t.
 *
 ...
 * @return 0 if success, negative if fail.
 */
static inline int32_t deserialize_cvdsp3_ErrorEnum(
							des_buf_t *buf,
							cvdsp3_ErrorEnum_t *out)
{
	uint32_t *ptr = NULL;
