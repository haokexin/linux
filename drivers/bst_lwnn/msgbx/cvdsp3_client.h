...
#ifndef CVDSP3_CLIENT_H
#define CVDSP3_CLIENT_H
 ...
 */
typedef void (*cvdsp3_disp_req_callback_t)(
				const uint32_t rep,
				const cvdsp3_ErrorEnum_t err,
				void *ext,
 ...
 * The data MAY CHANGED after leaving the callback function.
 */
typedef void (*cvdsp3_disp_run_callback_t)(
...
#define cvdsp3_client_t struct _cvdsp3_client_t

/**
 *  The extend data used by the client.
 */
struct _cvdsp3_client_ext_t {
	uint8_t cid;
	uint8_t ccid;
	uint8_t status;
	uint8_t res[5];
...
#define cvdsp3_client_ext_t struct _cvdsp3_client_ext_t

/**
 * Initializes the client.
 *
 * @param data The data for com_client_data_t
 * @param client The data for cvdsp3_client_t
 * @param ext The data for cvdsp3_client_ext_t
 * @return 0 if success, negative if fail.
 */
int32_t cvdsp3_client_init(com_client_data_t *data,
			cvdsp3_client_t *client,
			cvdsp3_client_ext_t *ext);

/**
 * Destroys the client.
 */
void cvdsp3_client_destroy(void);

#ifdef __cplusplus
}
#endif

#endif // CVDSP3_CLIENT_H
