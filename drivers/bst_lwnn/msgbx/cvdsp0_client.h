...
#ifndef CVDSP0_CLIENT_H
#define CVDSP0_CLIENT_H
 ...
 */
typedef void (*cvdsp0_disp_req_callback_t)(
				const uint32_t rep,
				const cvdsp0_ErrorEnum_t err,
				void *ext,
 ...
 * The data MAY CHANGED after leaving the callback function.
 */
typedef void (*cvdsp0_disp_run_callback_t)(
...
#define cvdsp0_client_t struct _cvdsp0_client_t

/**
 *  The extend data used by the client.
 */
struct _cvdsp0_client_ext_t {
	uint8_t cid;
	uint8_t ccid;
	uint8_t status;
	uint8_t res[5];
...
#define cvdsp0_client_ext_t struct _cvdsp0_client_ext_t

/**
 * Initializes the client.
 *
 * @param data The data for com_client_data_t
 * @param client The data for cvdsp0_client_t
 * @param ext The data for cvdsp0_client_ext_t
 * @return 0 if success, negative if fail.
 */
int32_t cvdsp0_client_init(com_client_data_t *data,
			cvdsp0_client_t *client,
			cvdsp0_client_ext_t *ext);

/**
 * Destroys the client.
 */
void cvdsp0_client_destroy(void);

#ifdef __cplusplus
}
#endif

#endif // CVDSP0_CLIENT_H
