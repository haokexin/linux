...
#ifndef CVDSP1_DATATYPE_H
#define CVDSP1_DATATYPE_H
...
// user defined types
enum _cvdsp1_ErrorEnum_t {
	CVDSP1_NO_ERROR = 0,
	CVDSP1_SERVER_FAIL = -1,
	CVDSP1_ERROR_PARA = -2,
	CVDSP1_ERROR_SYS = -3
};
#define cvdsp1_ErrorEnum_t enum _cvdsp1_ErrorEnum_t
...
/**
 * Deserialize cvdsp1_ErrorEnum_t.
 *
 ...
 * @return 0 if success, negative if fail.
 */
static inline int32_t deserialize_cvdsp1_ErrorEnum(
							des_buf_t *buf,
							cvdsp1_ErrorEnum_t *out)
{
	uint32_t *ptr = NULL;
