...
#ifndef CVDSP2_CLIENT_H
#define CVDSP2_CLIENT_H
 ...
 */
typedef void (*cvdsp2_disp_req_callback_t)(
				const uint32_t rep,
 ...
 * The data MAY CHANGED after leaving the callback function.
 */
typedef void (*cvdsp2_disp_run_callback_t)(
...
#define cvdsp2_client_t struct _cvdsp2_client_t

/**
 *  The extend data used by the client.
 */
struct _cvdsp2_client_ext_t {
	uint8_t cid;
	uint8_t ccid;
	uint8_t status;
	uint8_t res[5];
...
#define cvdsp2_client_ext_t struct _cvdsp2_client_ext_t

/**
 * Initializes the client.
 *
 * @param data The data for com_client_data_t
 * @param client The data for cvdsp2_client_t
 * @param ext The data for cvdsp2_client_ext_t
 * @return 0 if success, negative if fail.
 */
int32_t cvdsp2_client_init(com_client_data_t *data,
			cvdsp2_client_t *client,
