...
#ifndef CVDSP0_DATATYPE_H
#define CVDSP0_DATATYPE_H
...
// user defined types
enum _cvdsp0_ErrorEnum_t {
	CVDSP0_NO_ERROR = 0,
	CVDSP0_SERVER_FAIL = -1,
	CVDSP0_ERROR_PARA = -2,
	CVDSP0_ERROR_SYS = -3
};
#define cvdsp0_ErrorEnum_t enum _cvdsp0_ErrorEnum_t
...
/**
 * Deserialize cvdsp0_ErrorEnum_t.
 *
 ...
 * @return 0 if success, negative if fail.
 */
static inline int32_t deserialize_cvdsp0_ErrorEnum(
							des_buf_t *buf,
							cvdsp0_ErrorEnum_t *out)
{
	uint32_t *ptr = NULL;
