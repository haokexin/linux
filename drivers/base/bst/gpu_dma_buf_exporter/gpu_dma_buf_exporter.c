...
#include <uapi/base/bst/gpu_dma_buf_exporter/gpu_dma_buf_exporter.h>
#include <linux/of.h>
...
static const struct of_device_id dma_buf_of_match[] = {
        { .compatible = "bst,g78_dma_buf", },
        { /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, dma_buf_of_match);
#endif

#define DMA_BUF_TE_DRIVER_NAME "g78_dma_buf"
