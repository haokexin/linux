...
#ifdef CONFIG_RAM_CONSOLE_EARLY_INIT
static char __initdata
	ram_console_old_log_init_buffer[CONFIG_RAM_CONSOLE_EARLY_SIZE];
#endif
static char *ram_console_old_log;
static size_t ram_console_old_log_size;

static phys_addr_t ram_console_buffer_phys = 0;
...
#define ECC_BLOCK_SIZE CONFIG_RAM_CONSOLE_ERROR_CORRECTION_DATA_SIZE
#define ECC_SIZE CONFIG_RAM_CONSOLE_ERROR_CORRECTION_ECC_SIZE
#define ECC_SYMSIZE CONFIG_RAM_CONSOLE_ERROR_CORRECTION_SYMBOL_SIZE
#define ECC_POLY CONFIG_RAM_CONSOLE_ERROR_CORRECTION_POLYNOMIAL
#endif
...
static struct console ram_console = {
	...
	.flags	= CON_PRINTBUFFER | CON_ENABLED | CON_ATOMIC,
	.index	= -1,
};
...
#ifdef CONFIG_RAM_CONSOLE_ENABLE_VERBOSE
	console_verbose();
#endif
	return 0;
}
...
static int __init ram_console_early_init(void)
{
	return ram_console_init((struct ram_console_buffer *)
		CONFIG_RAM_CONSOLE_EARLY_ADDR,
		CONFIG_RAM_CONSOLE_EARLY_SIZE,
...
static int __init ram_console_module_init(void)
{
	...
	if(ram_console_buffer_phys != 0) {
		ram_console_buffer = __va(ram_console_buffer_phys);
		err = ram_console_init(ram_console_buffer,
				       ram_console_buffer_size,
				       NULL);
	}
	else {
...
static int __init early_parse_ramcon(char *p)
{
