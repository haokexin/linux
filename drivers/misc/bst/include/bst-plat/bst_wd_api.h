...
#ifndef _BST_WD_API_H_
#define _BST_WD_API_H_
/* WD MODE MARK BIT */
#define BST_WDT_REQ_DEBUG_EN_MARK		(0x80000)
#define BST_WDT_REQ_SPM_THERMAL_MARK		(0x0001)
#define BST_WDT_REQ_SPM_SCPSYS_MARK		(0x0002)
#define BST_WDT_REQ_EINT_MARK			(1<<2)
#define BST_WDT_REQ_SYSRST_MARK			(1<<3)
#define BST_WDT_REQ_THERMAL_MARK		(1<<18)
