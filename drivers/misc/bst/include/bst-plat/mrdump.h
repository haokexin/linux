...
#define MRDUMP_MINI_NR_SECTION 64
...
#define MRDUMP_MINI_HEADER_SIZE	\
	ALIGN(sizeof(struct mrdump_mini_elf_header) + \
	sizeof(struct aee_process_info), PAGE_SIZE)
...
#ifdef CONFIG_BST_RAM_CONSOLE_DRAM_ADDR
#define MRDUMP_MINI_BUF_PADDR (CONFIG_BST_RAM_CONSOLE_DRAM_ADDR + 0xf0000)
#else
...
#if defined(CONFIG_BST_AEE_IPANIC)
