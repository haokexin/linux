...
/**
 * Callback function for arm2isp_async method.
 *
 * @param result The output argument returned by arm2isp_async.
 ...
 */
typedef void (*video_arm2isp_callback_t)(
...
/**
 * Callback function for broadcast isp2arm.
 *
 * @param msgAddr The output argument returned by broadcast isp2arm.
 * @param ext The user-defined data passed to the method.
 * @param info The extended information, containing uuid and timestamp.
 * @note all the data are stored in ext_buf passed to async call.
 * If ext_buf is NULL, internal buffer will be used.
 ...
 * The data MAY CHANGED after leaving the callback function.
 */
typedef void (*video_isp2arm_callback_t)(
...
struct _video_client_t {
	 ...
	 *
	 * @param msgAddr The input argument of method arm2isp.
	 * @param result The output argument of method arm2isp.
	 * @param err The error code returned by the method.
	...
	/**
	 * Asynchronously call the arm2isp method.
	 *
	 * @param msgAddr The input argument of method arm2isp.
	...
	/**
	 * Subscribe to the isp2arm broadcast.
	 *
	...
	/**
	 * Unsubscribe from the isp2arm broadcast.
	 *
	 ...
	 */
	int32_t (*isp2arm_unsub)(broadcast_sub_unsub_callback_t cb, void *ext);
...
#define video_client_t struct _video_client_t

/**
 *  The extend data used by the client.
 */
struct _video_client_ext_t {
	uint8_t cid;
	uint8_t ccid;
	uint8_t status;
	uint8_t res[5];
	...
	void *avail_ext;
	callback_registration_t arm2isp_registry[IPC_TOKEN_NUM];
	callback_registration_t isp2arm_registry;
};
#define video_client_ext_t struct _video_client_ext_t

/**
 * Initializes the client.
 *
 * @param data The data for com_client_data_t
 * @param client The data for video_client_t
 * @param ext The data for video_client_ext_t
 * @return 0 if success, negative if fail.
 */
int32_t video_client_init(com_client_data_t *data,
