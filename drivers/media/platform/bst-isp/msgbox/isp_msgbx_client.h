...
#ifndef ISP_MSGBX_CLIENT_H
#define ISP_MSGBX_CLIENT_H
...
struct _isp_msgbx_client_t {
	video_client_t video_client;
...
#define isp_msgbx_client_t struct _isp_msgbx_client_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _isp_msgbx_client_data_t {
	com_client_data_t com_data;
	isp_msgbx_client_t client;
	video_client_ext_t video_ext;
};
#define isp_msgbx_client_data_t struct _isp_msgbx_client_data_t
