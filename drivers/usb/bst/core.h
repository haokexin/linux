...
#define DWC3_SS_TX_DE_EMPHASIS(n)   (((n) & 0x3) << 1)
#define DWC3_SS_TX_DE_EMPHASIS_MASK (0x3 << 1)
...
#define DWC3_GSBUSCFG0_REQINFO_DATA_READ(n) (((n) & 0xf) << 28)
#define DWC3_GSBUSCFG0_REQINFO_DATA_READ_MASK (0xf << 28)
#define DWC3_GSBUSCFG0_REQINFO_DES_READ(n) (((n) & 0xf) << 24)
#define DWC3_GSBUSCFG0_REQINFO_DES_READ_MASK (0xf << 24)
#define DWC3_GSBUSCFG0_REQINFO_DATA_WRITE(n) (((n) & 0xf) << 20)
#define DWC3_GSBUSCFG0_REQINFO_DATA_WRITE_MASK (0xf << 20)
#define DWC3_GSBUSCFG0_REQINFO_DES_WRITE(n) (((n) & 0xf) << 16)
#define DWC3_GSBUSCFG0_REQINFO_DES_WRITE_MASK (0xf << 16)
...
#if IS_ENABLED(CONFIG_USB_BST_DWC3_HOST) || IS_ENABLED(CONFIG_USB_BST_DWC3_DUAL_ROLE)
...
#if IS_ENABLED(CONFIG_USB_BST_DWC3_GADGET) || IS_ENABLED(CONFIG_USB_BST_DWC3_DUAL_ROLE)
...
#if IS_ENABLED(CONFIG_USB_BST_DWC3_DUAL_ROLE)
...
#if !IS_ENABLED(CONFIG_USB_BST_DWC3_HOST)
...
#if IS_ENABLED(CONFIG_USB_BST_DWC3_ULPI)
