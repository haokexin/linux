...
static const struct usb_ssp_isoc_ep_comp_descriptor ssp_isoc_source_comp_desc =
{
	bLength : USB_DT_SSP_ISOC_EP_COMP_SIZE,
	bDescriptorType : USB_DT_SSP_ISOC_ENDPOINT_COMP,
	wReseved : 0x0000,
	dwBytesPerInterval : 0x400
};
...
static const struct usb_ssp_isoc_ep_comp_descriptor ssp_isoc_sink_comp_desc =
{
	bLength : USB_DT_SSP_ISOC_EP_COMP_SIZE,
	bDescriptorType : USB_DT_SSP_ISOC_ENDPOINT_COMP,
	wReseved : 0x0000,
...
static ssize_t f_ss_opts_int_interval_show(struct config_item *item, char *page)
{
	struct f_ss_opts *opts = to_f_ss_opts(item);
	int result;
...
static ssize_t f_ss_opts_int_maxpacket_show(struct config_item *item, char *page)
{
	struct f_ss_opts *opts = to_f_ss_opts(item);
	int result;
...
static ssize_t f_ss_opts_int_maxburst_show(struct config_item *item, char *page)
{
	struct f_ss_opts *opts = to_f_ss_opts(item);
	int result;
