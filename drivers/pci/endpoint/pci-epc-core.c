...
/**
 * devm_pci_epc_release() - release the EPC device
 * @dev: device that wants to release the EPC
 *
 * It is only a empty release function.
 */
static void epc_release(struct device *dev)
{
}
