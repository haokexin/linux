...
#ifndef THERMALCLIENT_H
#define THERMALCLIENT_H
...
struct _thermalclient_t {
	st_public1_client_t st_public1_client;
...
#define thermalclient_t struct _thermalclient_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _thermalclient_data_t {
	com_client_data_t com_data;
	thermalclient_t client;
	st_public1_client_ext_t st_public1_ext;
};
#define thermalclient_data_t struct _thermalclient_data_t
