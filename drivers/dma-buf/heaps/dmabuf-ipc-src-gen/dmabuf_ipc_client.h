...
struct _dmabuf_ipc_client_t {
	r5mem_client_t r5mem_client;
...
#define dmabuf_ipc_client_t struct _dmabuf_ipc_client_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _dmabuf_ipc_client_data_t {
	com_client_data_t com_data;
	dmabuf_ipc_client_t client;
	r5mem_client_ext_t r5mem_ext;
};
#define dmabuf_ipc_client_data_t struct _dmabuf_ipc_client_data_t
