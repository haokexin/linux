...
#ifndef ST_PUBLIC_CLIENT_H
#define ST_PUBLIC_CLIENT_H
 ...
 */
typedef void (*st_public_qspi_method_callback_t)(
 ...
 * The data MAY CHANGED after leaving the callback function.
 */
typedef void (*st_public_scmi_method_callback_t)(
				const st_public_ErrorEnum_t err,
				void *ext,
				const ext_info_t *info
				);
 ...
 * The data MAY CHANGED after leaving the callback function.
 */
typedef void (*st_public_gettemp_method_callback_t)(
...
#define st_public_client_t struct _st_public_client_t

/**
 *  The extend data used by the client.
 */
struct _st_public_client_ext_t {
	uint8_t cid;
	uint8_t ccid;
	uint8_t status;
	uint8_t res[5];
...
#define st_public_client_ext_t struct _st_public_client_ext_t

/**
 * Initializes the client.
 *
 * @param data The data for com_client_data_t
 * @param client The data for st_public_client_t
 * @param ext The data for st_public_client_ext_t
 * @return 0 if success, negative if fail.
 */
int32_t st_public_client_init(com_client_data_t *data,
			st_public_client_t *client,
