...
static uint32_t hw_version(void)
{
    ...
    if (0 == version)
    {
        version = mver_blk1_reg_get_version();
    }
    return version;
}
...
static const struct mve_mem_virt_region *get_mem_virt_regions(void)
{
    ...
    {
        return mve_blk1_com_hi_v3_get_mem_virt_region();
    }
    else
    {
        return mve_blk1_com_hi_v2_get_mem_virt_region();
    }

    return NULL;
}

void mve_blk1_mem_virt_region_get(enum mve_mem_virt_region_type type,
...
enum mve_mem_virt_region_type mve_blk1_mem_virt_region_type_get(mve_addr_t mve_addr)
{
