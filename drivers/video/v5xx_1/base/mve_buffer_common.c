...
#include "mve_blk1_buffer_valloc.h"
#include "mve_blk1_buffer_attachment.h"
#include "mve_blk1_buffer_dmabuf.h"
#include "mve_blk1_buffer_ashmem.h"
...
{
    {   /* Valloc */
        .create_buffer_external  = mve_blk1_buffer_valloc_create_buffer_external,
        .destroy_buffer_external = mve_blk1_buffer_valloc_destroy_buffer_external,
        .map_physical_pages      = mve_blk1_buffer_valloc_map_physical_pages,
        .unmap_physical_pages    = mve_blk1_buffer_valloc_unmap_physical_pages,
        .set_owner               = mve_blk1_buffer_valloc_set_owner
    },
    {   /* Attachment */
        .create_buffer_external  = mve_blk1_buffer_attachment_create_buffer_external,
        .destroy_buffer_external = mve_blk1_buffer_attachment_destroy_buffer_external,
        .map_physical_pages      = mve_blk1_buffer_attachment_map_physical_pages,
        .unmap_physical_pages    = mve_blk1_buffer_attachment_unmap_physical_pages,
        .set_owner               = mve_blk1_buffer_attachment_set_owner
    },
#ifndef EMULATOR
    {   /* dma buf */
        .create_buffer_external  = mve_blk1_buffer_dmabuf_create_buffer_external,
        .destroy_buffer_external = mve_blk1_buffer_dmabuf_destroy_buffer_external,
        .map_physical_pages      = mve_blk1_buffer_dmabuf_map_physical_pages,
        .unmap_physical_pages    = mve_blk1_buffer_dmabuf_unmap_physical_pages,
        .set_owner               = mve_blk1_buffer_dmabuf_set_owner
    },
    {   /* ashmem buf */
        .create_buffer_external  = mve_blk1_buffer_ashmem_create_buffer_external,
        .destroy_buffer_external = mve_blk1_buffer_ashmem_destroy_buffer_external,
        .map_physical_pages      = mve_blk1_buffer_ashmem_map_physical_pages,
        .unmap_physical_pages    = mve_blk1_buffer_ashmem_unmap_physical_pages,
        .set_owner               = mve_blk1_buffer_ashmem_set_owner
    }
#endif
};

bool mve_blk1_buffer_is_valid(const struct mve_buffer_info *info)
{
    int bpp, size;
...
struct mve_buffer_external *mve_blk1_buffer_create_buffer_external(struct mve_buffer_info *info, uint32_t port)
{
...
void mve_blk1_buffer_destroy_buffer_external(struct mve_buffer_external *buffer)
{
    allocators[buffer->info.allocator].destroy_buffer_external(buffer);
}

bool mve_blk1_buffer_map_physical_pages(struct mve_buffer_external *buffer)
{
    return allocators[buffer->info.allocator].map_physical_pages(buffer);
}

bool mve_blk1_buffer_unmap_physical_pages(struct mve_buffer_external *buffer)
{
    return allocators[buffer->info.allocator].unmap_physical_pages(buffer);
}

void mve_blk1_buffer_set_owner(struct mve_buffer_external *buffer,
                          enum mve_buffer_owner owner,
                          enum mve_port_index port)
{
