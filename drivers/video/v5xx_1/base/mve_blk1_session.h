...
#endif                                          /**< Timestamp marking the most recent
...
struct mve_session
{
    ...
    int lsid;                                   /**< The logical lsid of the session  */
};
 ...
 */
mve_base_error mve_blk1_session_enqueue_flush_buffers(struct mve_session *session,
                                                 uint32_t flush);
 ...
 * @return MVE error code.
 */
mve_base_error mve_blk1_session_enqueue_state_change(struct mve_session *session,
