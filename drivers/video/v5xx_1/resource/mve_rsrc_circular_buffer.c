...
struct mver_circular_buffer *mver_blk1_circular_buffer_create(int size)
{
...
void mver_blk1_circular_buffer_destroy(struct mver_circular_buffer *cb)
{
    if (NULL != cb)
    {
...
static bool has_free_element(struct mver_circular_buffer *cb)
{
    ...
    return mver_blk1_circular_buffer_get_num_entries(cb) < cb->size - 1;
}

bool mver_blk1_circular_buffer_add(struct mver_circular_buffer *cb, void *item)
{
    bool ret = false;
...
bool mver_blk1_circular_buffer_remove(struct mver_circular_buffer *cb, void **data)
{
    bool ret = false;

    if (mver_blk1_circular_buffer_get_num_entries(cb) > 0)
    {
...
int mver_blk1_circular_buffer_get_num_entries(struct mver_circular_buffer *cb)
{
    int num = 0;
...
bool mver_blk1_circular_buffer_peek(struct mver_circular_buffer *cb, void **data)
{
    bool ret = false;
...
void mver_blk1_circular_buffer_remove_all_occurences(struct mver_circular_buffer *cb, void *data)
{
    int curr;
