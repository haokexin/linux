...
#define __MVE_LOG_PRINT(_lg, _severity, _fmt, ...)           \
    (_lg)->drain->print((_lg)->drain, _severity, (_lg)->tag, \
                        ...
                        ##__VA_ARGS__,                       \
                        mve_blk1_rsrc_log_strrchr(__FILE__), __LINE__)
#else
#define __MVE_LOG_PRINT(_lg, _severity, _fmt, ...)                 \
...
extern struct mve_rsrc_log_group mve_blk1_rsrc_log;
extern struct mve_rsrc_log_group mve_blk1_rsrc_log_scheduler;
extern struct mve_rsrc_log_group mve_blk1_rsrc_log_fwif;
extern struct mve_rsrc_log_group mve_blk1_rsrc_log_session;
 ...
 */
inline static void mve_blk1_rsrc_log_trim(char *str)
{
