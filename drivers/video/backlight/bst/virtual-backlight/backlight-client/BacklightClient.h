...
#ifndef BACKLIGHTCLIENT_H
#define BACKLIGHTCLIENT_H
...
struct _BacklightClient_t {
	backlight_client_t backlight_client;
...
#define BacklightClient_t struct _BacklightClient_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _BacklightClient_data_t {
	com_client_data_t com_data;
	BacklightClient_t client;
	backlight_client_ext_t backlight_ext;
};
#define BacklightClient_data_t struct _BacklightClient_data_t
