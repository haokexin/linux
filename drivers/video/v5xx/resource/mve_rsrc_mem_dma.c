...
{
    {
        .alloc = mve_rsrc_dma_mem_alloc_uncached,
        .free = mve_rsrc_dma_mem_free_uncached,
        .clean_cache = mve_rsrc_dma_mem_clean_cache_uncached,
        .invalidate_cache = mve_rsrc_dma_mem_invalidate_cache_uncached,
        .map = mve_rsrc_dma_mem_map_uncached,
        .unmap = mve_rsrc_dma_mem_unmap_unchached,
        .get_pages = mve_rsrc_dma_mem_get_pages_uncached,
    }
};
