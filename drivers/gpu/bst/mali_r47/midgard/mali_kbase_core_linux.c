...
#include "uapi/gpu/bst/mali_r47/midgard/mali_kbase_mem_profile_debugfs_buf_size.h"
...
#include <uapi/gpu/bst/mali_r47/midgard/mali_kbase_ioctl.h>
#if !MALI_USE_CSF
...
static void kbase_platform_device_shutdown(struct platform_device *pdev)
{
	...
	//clear all gpu irq then disable gpu irq
	kbase_release_interrupts(kbdev);

	dev_warn(kbdev->dev, "mali gpu shutdown!\n");
}
