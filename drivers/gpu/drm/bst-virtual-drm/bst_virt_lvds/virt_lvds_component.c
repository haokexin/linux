...
static void lvds_enable(struct bst_virt_component *c)
{
...
static int lvds_get_modes(struct bst_virt_component *c)
{
...
static int lvds_detect(struct bst_virt_component *c)
{
	return connector_status_connected;
}

const static struct bst_virt_component_funcs lvds_funcs = {
	.enable = lvds_enable,
