...
struct _DisplayClient_t {
	display_client_t display_client;
...
#define DisplayClient_t struct _DisplayClient_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _DisplayClient_data_t {
	com_client_data_t com_data;
	DisplayClient_t client;
	display_client_ext_t display_ext;
};
#define DisplayClient_data_t struct _DisplayClient_data_t
