...
static int ndesc_get_tx_status(void *data, struct bstgmac_extra_stats *x,
 ...
 */
static int ndesc_get_rx_status(void *data, struct bstgmac_extra_stats *x,
			       struct dma_desc *p)
{
	int ret = good_frame;
...
const struct bstgmac_desc_ops ndesc_ops = {
