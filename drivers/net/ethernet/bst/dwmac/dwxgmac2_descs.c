...
static int dwxgmac2_get_tx_status(void *data, struct bstgmac_extra_stats *x,
...
static int dwxgmac2_get_rx_status(void *data, struct bstgmac_extra_stats *x,
				  struct dma_desc *p)
{
...
const struct bstgmac_desc_ops dwxgmac210_desc_ops = {
...
const struct bstgmac_mode_ops dwxgmac_ring_mode_ops = { };