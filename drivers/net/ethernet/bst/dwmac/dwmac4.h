...
#define GMAC_MTL_TXQ_OPMODE(reg)	(0xd00 + (reg) * 0x40)

/* MAC MTL TXQ */
#define GMAC_MTL_TXQ_OPMODE_FTQ		BIT(0)
...
#define GMAC_PACKET_FILTER_HUC      	BIT(1)
#define GMAC_PACKET_FILTER_HMC		BIT(2)
#define GMAC_PACKET_FILTER_DAIF     	BIT(3)
#define GMAC_PACKET_FILTER_PM		BIT(4)
#define GMAC_PACKET_FILTER_PCF		BIT(7)
#define GMAC_PACKET_FILTER_SAIF		BIT(8)
...
#define	GMAC_INT_DEFAULT_ENABLE	(GMAC_INT_PMT_EN)
//GMAC_INT_LPI_EN
...
#define MTL_OP_MODE_TTC_64		BIT(MTL_OP_MODE_TTC_SHIFT)
...
//modify by qiwei.chen 2020/2/17
//RTC SHIFT is bit 1:0
#define MTL_OP_MODE_RTC_MASK		0x3
#define MTL_OP_MODE_RTC_SHIFT		0

#define MTL_OP_MODE_RTC_32		BIT(MTL_OP_MODE_RTC_SHIFT)
