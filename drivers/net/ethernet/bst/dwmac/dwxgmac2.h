...
#define XGMAC_LPI_CTRL_STATUS_TLPIEN	BIT(0) /* Transmit LPI Entry */
#define XGMAC_LPI_CTRL_STATUS_TLPIEX	BIT(1) /* Transmit LPI Exit */
#define XGMAC_LPI_CTRL_STATUS_RLPIEX	BIT(3) /* Receive LPI Exit */
#define XGMAC_LPI_CTRL_STATUS_RLPIEN	BIT(2) /* Receive LPI Entry */
#define XGMAC_LPI_CTRL_STATUS	0xd0
...
#define XGMAC_MAC_FSM_ACT_TIMER		0x0000015c
#define XGMAC_MAC_SCSR_CONTROL		0x00000164
#define XGMAC_CPEN			BIT(0)
...
#define XGMAC_TSIPENA			BIT(11)
#define XGMAC_TSVER2ENA			BIT(10)
#define XGMAC_TSTRIG			BIT(4)
#define XGMAC_TIMESTAMP_CTRL		0x00000d00
...
#define XGMAC_PPSCMD_SINGLE_START		0x1
#define XGMAC_PPSCMD_PULSE_TRAIN_START  0x2
#define XGMAC_PPSCMD_RESERVE    0x1
...
#define XGMAC_MTL_TBS_CTRL		0x00001048
#define XGMAC_MTL_TBS_STATS		0x0000104c
...
#define XGMAC_EPSI			BIT(2)
#define XGMAC_DDPP			BIT(0)
#define XGMAC_MTL_SGF_CONTROL		0x000010e8
#define XGMAC_ESGF			BIT(0)
...
#define XGMAC_THC_MASK			GENMASK(19, 16)
#define XGMAC_THC_SHIFT			16
#define XGMAC_TEC_MASK			GENMASK(11, 8)
#define XGMAC_TEC_SHIFT			8
#define XGMAC_TDRC_MASK			GENMASK(3, 0)
#define XGMAC_TDRC_SHIFT		0
#define XGMAC_AXI_RX_AW_ACE_CTRL	0x00003018
#define XGMAC_RDC_MASK			GENMASK(27, 24)
#define XGMAC_RDC_SHIFT			24
#define XGMAC_RHC_MASK			GENMASK(19, 16)
#define XGMAC_RHC_SHIFT			16
#define XGMAC_RPC_MASK			GENMASK(11, 8)
#define XGMAC_RPC_SHIFT			8
#define XGMAC_RDWC_MASK			GENMASK(3, 0)
#define XGMAC_RDWC_SHIFT		0
#define XGMAC_AXI_TXRX_AWAR_ACE_CTRL	0x0000301c
#define XGMAC_RDRC_MASK			GENMASK(11, 8)
#define XGMAC_RDRC_SHIFT		8
#define XGMAC_TDWC_MASK			GENMASK(3, 0)
#define XGMAC_TDWC_SHIFT		0
...
#define XGMAC_DMA_INT_DEFAULT_EN	(XGMAC_NIE | XGMAC_AIE | XGMAC_RBUE | \
					XGMAC_RIE | XGMAC_TIE)
#define XGMAC_DMA_INT_DEFAULT_RX	(XGMAC_RBUE | XGMAC_RIE | XGMAC_RSE)
...
#define XGMAC_DMA_CH_RX_DESC_WR_RING_OFFSET(x)	(0x0000317c + (0x80 * (x)))
#define XGMAC_DMA_CH_TX_DESC_WR_RING_OFFSET(x)	(0x00003178 + (0x80 * (x)))
#define XGMAC_DMA_CH_CUR_APP_TXDESC_H(x)	(0x00003140 + (0x80 * (x)))
#define XGMAC_DMA_CH_CUR_APP_TXDESC_L(x)	(0x00003144 + (0x80 * (x)))
#define XGMAC_DMA_CH_CUR_APP_RXDESC_H(x)	(0x00003148 + (0x80 * (x)))
#define XGMAC_DMA_CH_CUR_APP_RXDESC_L(x)	(0x0000314c + (0x80 * (x)))
#define XGMAC_DMA_CH_CURRENT_APP_TXBUFFER_H(x)	(0x00003150 + (0x80 * (x)))
#define XGMAC_DMA_CH_CURRENT_APP_TXBUFFER_L(x)	(0x00003154 + (0x80 * (x)))
#define XGMAC_DMA_CH_CURRENT_APP_RXBUFFER_H(x)	(0x00003158 + (0x80 * (x)))
#define XGMAC_DMA_CH_CURRENT_APP_RXBUFFER_L(x)	(0x0000315c + (0x80 * (x)))
#define XGMAC_DMA_CH_DBG_STATUS(x)	(0x00003164 + (0x80 * (x)))
#define XGMAC_DMA_CH_DESC_MEM_CACHE_FILL_LEVEL(x)	(0x00003168 + (0x80 * (x)))
#define XGMAC_DMA_CH_MISS_PACKET_CNT_REG(x)	(0x0000316c + (0x80 * (x)))
#define XGMAC_DMA_CH_TX_DATA_XFER_RING_OFFSET(x)	(0x00003170 + (0x80 * (x)))
#define XGMAC_DMA_CH_RX_DATA_XFER_RING_OFFSET(x)	(0x00003174 + (0x80 * (x)))
#define XGMAC_DMA_AS_SFTY_ECC_INTR_STS 0x0000308c
#define XGMAC_WDUES         BIT(3)
#define XGMAC_WDCES         BIT(2)
#define XGMAC_DMA_INT_MODE_SHIFT		12
