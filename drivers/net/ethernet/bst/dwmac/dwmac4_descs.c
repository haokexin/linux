...
static int dwmac4_wrback_get_tx_status(void *data, struct bstgmac_extra_stats *x,
				       struct dma_desc *p,
				       void __iomem *ioaddr)
{
...
static int dwmac4_wrback_get_rx_status(void *data, struct bstgmac_extra_stats *x,
				       struct dma_desc *p)
{
	struct net_device_stats *stats = (struct net_device_stats *)data;
...
static void dwmac4_set_addr(struct dma_desc *p, dma_addr_t addr)
{
	...
	p->des1 = cpu_to_le32((addr >> 32) & 0xff);
}
...
const struct bstgmac_desc_ops dwmac4_desc_ops = {
...
const struct bstgmac_mode_ops dwmac4_ring_mode_ops = { };
