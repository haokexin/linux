...
static int enh_desc_get_tx_status(void *data, struct bstgmac_extra_stats *x,
...
static void enh_desc_get_ext_status(void *data, struct bstgmac_extra_stats *x,
...
static int enh_desc_get_rx_status(void *data, struct bstgmac_extra_stats *x,
				  struct dma_desc *p)
{
	struct net_device_stats *stats = (struct net_device_stats *)data;
...
const struct bstgmac_desc_ops enh_desc_ops = {
