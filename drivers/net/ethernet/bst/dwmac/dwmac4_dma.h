...
/**/
#define DMA_INT_MODE_MASK		GENMASK(17, 16)
#define DMA_INT_MODE_SHIFT		16
...
#define DMA_CHAN_INTR_DEFAULT_RX	(DMA_CHAN_INTR_ENA_RIE | DMA_CHAN_INTR_ENA_RBUE)
#define DMA_CHAN_INTR_DEFAULT_TX	(DMA_CHAN_INTR_ENA_TIE | DMA_CHAN_INTR_ENA_TBUE)					 
...
int dwmac4_dma_interrupt(void __iomem *ioaddr, struct bstgmac_extra_stats *x, u32 chan, u32 flag);
void dwmac4_set_rx_ring_len(void __iomem *ioaddr, u32 len, u32 chan);
void dwmac4_set_tx_ring_len(void __iomem *ioaddr, u32 len, u32 chan);
void dwmac4_set_rx_tail_ptr(void __iomem *ioaddr, u32 tail_ptr, u32 chan);
void dwmac4_set_tx_tail_ptr(void __iomem *ioaddr, u32 tail_ptr, u32 chan);
int bstgmac_dma_ri_interrupt(void __iomem *ioaddr, struct bstgmac_extra_stats *x, u32 chan);
int bstgmac_dma_ti_interrupt(void __iomem *ioaddr, struct bstgmac_extra_stats *x, u32 chan);
