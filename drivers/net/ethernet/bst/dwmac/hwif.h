...
#define bstgmac_get_rx_hash(__priv, __args...) \
	stmmac_do_callback(__priv, desc, get_rx_hash, __args)
#define bstgmac_get_rx_header_len(__priv, __args...) \
	stmmac_do_callback(__priv, desc, get_rx_header_len, __args)
#define bstgmac_set_desc_sec_addr(__priv, __args...) \
	stmmac_do_void_callback(__priv, desc, set_sec_addr, __args)
#define bstmac_set_desc_sarc(__priv, __args...) \
...
#define bstmac_set_desc_tbs(__priv, __args...) \
...
struct bstgmac_dma_ops {
	...
	void (*mac_rxq_flush)(void __iomem *ioaddr, u32 rx_channel_cnt, bool enable);
	int (*enable_tbs)(void __iomem *ioaddr, bool en, u32 chan);
	void (*enable_rxo_int)(void __iomem *ioaddr, bool en, u32 chan);
};
...
#define bstgmac_enable_sph(__priv, __args...) \
	stmmac_do_void_callback(__priv, dma, enable_sph, __args)
#define bstgmac_mac_rxq_flush(__priv, __args...) \
	stmmac_do_void_callback(__priv, dma, mac_rxq_flush, __args)
#define bstmac_enable_tbs(__priv, __args...) \
	stmmac_do_callback(__priv, dma, enable_tbs, __args)
#define bstmac_enable_rxo_int(__priv, __args...) \
	stmmac_do_void_callback(__priv, dma, enable_rxo_int, __args)
...
struct bstgmac_ops {
	...
	/* Handle wdata ucerr interrupts hw dependent */
	int (*wdata_ucerr_irq_status)(struct mac_device_info *hw, struct bstgmac_extra_stats *x);
    /* Handle paddr parity interrupts hw dependent */
	int (*paddr_parity_irq_status)(struct mac_device_info *hw, struct bstgmac_extra_stats *x);
	...
	void (*set_umac_addr)(struct mac_device_info *hw, const unsigned char *addr,
			      unsigned int reg_n);
	...
	void (*fpe_configure)(void __iomem *ioaddr, u32 tx_mask, u32 num_rxq,
			  u32 min_fsize, bool enable);
	void (*fpe_get_config)(void __iomem *ioaddr, struct ethtool_fpe *eth_fpe);
	...
	int (*config_l4_filter)(struct mac_device_info *hw, u32 filter_no,
				...
				u32 match);
	/* mac tx queue flush */
	void (*mac_txq_flush)(struct mac_device_info *hw, u32 txq_cnt, bool enable);
	/* TX Timestamp */
	int (*get_mac_tx_timestamp)(struct mac_device_info *hw, u64 *ts);
	int (*sgf_configure)(void __iomem *ioaddr, struct stmmac_est *cfg,
			     unsigned int ptp_rate);
};
...
#define bstgmac_wdata_ucerr_irq_status(__priv, __args...) \
		stmmac_do_callback(__priv, mac, wdata_ucerr_irq_status, __args)
#define bstgmac_paddr_parity_irq_status(__priv, __args...) \
		stmmac_do_callback(__priv, mac, paddr_parity_irq_status, __args)
...
#define bstgmac_fpe_configure(__priv, __args...) \
	stmmac_do_void_callback(__priv, mac, fpe_configure, __args)
#define bstgmac_fpe_get_config(__priv, __args...) \
	stmmac_do_void_callback(__priv, mac, fpe_get_config, __args)
#define bstgmac_fpe_send_mpacket(__priv, __args...) \
	stmmac_do_void_callback(__priv, mac, fpe_send_mpacket, __args)
#define bstgmac_fpe_irq_status(__priv, __args...) \
...
#define bstmac_sarc_configure(__priv, __args...) \
...
#define bstgmac_mac_txq_flush(__priv, __args...) \
	stmmac_do_void_callback(__priv, mac, mac_txq_flush, __args)
#define bstgmac_rss_configure(__priv, __args...) \
		stmmac_do_callback(__priv, mac, rss_configure, __args)
#define bstgmac_get_mac_tx_timestamp(__priv, __args...) \
		stmmac_do_callback(__priv, mac, get_mac_tx_timestamp, __args)
#define bstmac_set_mac_loopback(__priv, __args...) \
	stmmac_do_void_callback(__priv, mac, set_mac_loopback, __args)
#define bstmac_sgf_configure(__priv, __args...) \
	stmmac_do_callback(__priv, mac, sgf_configure, __args)
...
struct bstgmac_tc_ops {
	...
	int (*setup_etf)(struct bstgmac_priv *priv,
			 struct tc_etf_qopt_offload *qopt);
};

struct bstgmac_counters;
...
#define bstmac_tc_setup_etf(__priv, __args...) \
	stmmac_do_callback(__priv, tc, setup_etf, __args)
struct bstgmac_mmc_ops {
	void (*ctrl)(void __iomem *ioaddr, unsigned int mode);
	void (*intr_all_mask)(void __iomem *ioaddr);
	void (*read)(void __iomem *ioaddr, struct bstgmac_counters *mmc);
};

#define bstmac_mmc_ctrl(__priv, __args...) \
	stmmac_do_void_callback(__priv, mmc, ctrl, __args)
#define bstmac_mmc_intr_all_mask(__priv, __args...) \
	stmmac_do_void_callback(__priv, mmc, intr_all_mask, __args)
#define bstmac_mmc_read(__priv, __args...) \
	stmmac_do_void_callback(__priv, mmc, read, __args)

/* XPCS callbacks */
#define bstmac_xpcs_validate(__priv, __args...) \
	stmmac_do_callback(__priv, xpcs, validate, __args)
#define bstmac_xpcs_config(__priv, __args...) \
	stmmac_do_callback(__priv, xpcs, config, __args)
#define bstmac_xpcs_get_state(__priv, __args...) \
	stmmac_do_callback(__priv, xpcs, get_state, __args)
#define bstmac_xpcs_link_up(__priv, __args...) \
	stmmac_do_callback(__priv, xpcs, link_up, __args)
#define bstmac_xpcs_probe(__priv, __args...) \
...
extern const struct bstgmac_mmc_ops dwxgmac_mmc_ops;
extern const struct bstgmac_mmc_ops dwmac_mmc_ops;
