...
#ifndef SECURITY_CLIENT_H
#define SECURITY_CLIENT_H
...
#define security_client_t struct _security_client_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _security_client_data_t {
	com_client_data_t com_data;
	security_client_t client;
	service_client_ext_t service_ext;
};
#define security_client_data_t struct _security_client_data_t
