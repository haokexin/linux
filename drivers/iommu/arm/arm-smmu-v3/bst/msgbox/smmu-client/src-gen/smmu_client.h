...
#ifndef SMMU_CLIENT_H
#define SMMU_CLIENT_H
...
struct _smmu_client_t {
	mapping_client_t mapping_client;
...
#define smmu_client_t struct _smmu_client_t

/**
 *  The internal data used by the client.
 *  Users should define an instance and pass it to the initialization function.
 */
struct _smmu_client_data_t {
	com_client_data_t com_data;
	smmu_client_t client;
	mapping_client_ext_t mapping_ext;
};
#define smmu_client_data_t struct _smmu_client_data_t
