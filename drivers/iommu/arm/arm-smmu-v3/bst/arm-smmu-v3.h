...
struct smmuv3_s2r_ctx {
	...
	u32 smmu_agbpa;
	u32 smmu_irq_ctrl;
	u64 smmu_strtab_base;
	u32 smmu_strtab_base_cfg;
	u64 smmu_cmdq_base;
	u32 smmu_cmdq_prod;
	u32 smmu_cmdq_cons;
	u64 smmu_evtq_base;
...
struct arm_smmu_device {
	...
	/* bst smmu csr reg */
	void __iomem			*page2_csr;
#define BST_SMMU_CSR_BASE	(0x1f0000)
...
/* bst cmn features define */
#define ARM_SMMU_FEAT_STAGE2_ONLY		(1 << 28)
#define ARM_SMMU_FEAT_MULTI_OS			(1 << 29)
#define ARM_SMMU_FEAT_TCU_CMN			(1 << 30)
#define ARM_SMMU_FEAT_DEVICE_CMN		(1 << 31)
	u32				features;

/* bst cmn address offset define , start */
#define CMN_DEVICE_ADDR_OFFSET_SET			BIT(36)		/* device --> cmn --> ddr, address offset 0x10—— */
#define CMN_DEVICE_ADDR_OFFSET_MASK			(~BIT(36))
