					     ...
					     struct arm_lpae_io_pgtable *data, bool cmn_tcu_offset_flag, int lvl)
{
	...
	/* cmn */ /* add cmn address offset */ /* printk("%s %d, new = 0x%llx *ptep = 0x%llx\n", __func__, __LINE__, new, readq(ptep)); */
	if (cmn_tcu_offset_flag)
		new |=  CMN_TCU_ADDR_OFFSET_SET;
			  ...
			  gfp_t gfp, size_t *mapped)
{
	...
	/* cmn */ /* cpu read ptep, need handle */ /* printk("%s, %d pte 0x%llx\n", __func__, __LINE__, pte); */
