...
crypto_create_session(struct fcrypt *fcr, struct session_op *sop)
{
	...
	int ret = 0;
	const char *skciper_name = NULL;
	const char *hash_name = NULL;
	const char *akciper_name = NULL;
	...
	if (unlikely(!sop->cipher && !sop->mac  && !sop->akcipher)) {
		derr(1, "Both 'cipher' and 'akcipher' and 'mac' unset.");
		return -EINVAL;
	}
	...
	case 0:
		break;
	case CRYPTO_BST_RSA:
		akciper_name = "bst_rsa";
		break;
	case CRYPTO_BST_SM2:
		akciper_name = "bst_sm2";
		break;
	case CRYPTO_BST_ECDSA:
		akciper_name = "bst_ecdsa";
		break;
	case CRYPTO_BST_RSA_CPU:
		akciper_name = "bst_rsa";
		break;
	case CRYPTO_BST_SM2_CPU:
		akciper_name = "bst_sm2";
		break;
	case CRYPTO_BST_ECDSA_CPU:
		akciper_name = "bst_ecdsa";
		break;
	default:
		derr(1, "bad akcipher: %d", sop->akcipher);
		return -EINVAL;
	}
	...
	case 0:
		break;
	case CRYPTO_DES_CBC:
		skciper_name = "cbc(des)";
		break;
	case CRYPTO_3DES_CBC:
		skciper_name = "cbc(des3_ede)";
		break;
	case CRYPTO_BLF_CBC:
		skciper_name = "cbc(blowfish)";
		break;
	case CRYPTO_AES_CBC:
		skciper_name = "cbc(aes)";
		break;
	case CRYPTO_AES_ECB:
		skciper_name = "ecb(aes)";
		break;
	case CRYPTO_AES_CFB:
		skciper_name = "cfb(aes)";
		break;
	case CRYPTO_AES_OFB:
		skciper_name = "ofb(aes)";
		break;
	case CRYPTO_AES_XTS:
		skciper_name = "xts(aes)";
		break;
	case CRYPTO_CAMELLIA_CBC:
		skciper_name = "cbc(camellia)";
		break;
	case CRYPTO_AES_CTR:
		skciper_name = "ctr(aes)";
		stream = 1;
		break;
	case CRYPTO_AES_GCM:
		skciper_name = "gcm(aes)";
		stream = 1;
		aead = 1;
		break;
	case CRYPTO_AES_CCM:
		skciper_name = "ccm(aes)";
		stream = 1;
		aead = 1;
		break;
	case CRYPTO_TLS11_AES_CBC_HMAC_SHA1:
		skciper_name = "tls11(hmac(sha1),cbc(aes))";
		stream = 0;
		aead = 1;
		break;
	case CRYPTO_TLS12_AES_CBC_HMAC_SHA256:
		skciper_name = "tls12(hmac(sha256),cbc(aes))";
		stream = 0;
		aead = 1;
		break;
	case CRYPTO_NULL:
		skciper_name = "ecb(cipher_null)";
		stream = 1;
		break;
	case CRYPTO_BST_AES256_ECB:
		skciper_name = "bst_ecb_aes_256_dma";
		break;
	case CRYPTO_BST_AES256_XTS:
		skciper_name = "bst_xts_aes_256_dma";
		break;
	case CRYPTO_BST_AES256_CBC:
		skciper_name = "bst_cbc_aes_256_dma";
		break;
	case CRYPTO_BST_AES256_CFB:
		skciper_name = "bst_cfb_aes_256_dma";
		break;
	case CRYPTO_BST_AES256_OFB:
		skciper_name = "bst_ofb_aes_256_dma";
		break;
	case CRYPTO_BST_AES256_CTR:
		skciper_name = "bst_ctr_aes_256_dma";
		break;
	case CRYPTO_BST_AES256_CBC_MAC:
		skciper_name = "bst_cbc_mac_aes_256_dma";
		break;
	case CRYPTO_BST_AES256_CMAC:
		skciper_name = "bst_cmac_aes_256_dma";
		break;
	case CRYPTO_BST_AES192_ECB:
		skciper_name = "bst_ecb_aes_192_dma";
		break;
	case CRYPTO_BST_AES192_XTS:
		skciper_name = "bst_xts_aes_192_dma";
		break;
	case CRYPTO_BST_AES192_CBC:
		skciper_name = "bst_cbc_aes_192_dma";
		break;
	case CRYPTO_BST_AES192_CFB:
		skciper_name = "bst_cfb_aes_192_dma";
		break;
	case CRYPTO_BST_AES192_OFB:
		skciper_name = "bst_ofb_aes_192_dma";
		break;
	case CRYPTO_BST_AES192_CTR:
		skciper_name = "bst_ctr_aes_192_dma";
		break;
	case CRYPTO_BST_AES192_CBC_MAC:
		skciper_name = "bst_cbc_mac_aes_192_dma";
		break;
	case CRYPTO_BST_AES192_CMAC:
		skciper_name = "bst_cmac_aes_192_dma";
		break;
	case CRYPTO_BST_AES128_ECB:
		skciper_name = "bst_ecb_aes_128_dma";
		break;
	case CRYPTO_BST_AES128_XTS:
		skciper_name = "bst_xts_aes_128_dma";
		break;
	case CRYPTO_BST_AES128_CBC:
		skciper_name = "bst_cbc_aes_128_dma";
		break;
	case CRYPTO_BST_AES128_CFB:
		skciper_name = "bst_cfb_aes_128_dma";
		break;
	case CRYPTO_BST_AES128_OFB:
		skciper_name = "bst_ofb_aes_128_dma";
		break;
	case CRYPTO_BST_AES128_CTR:
		skciper_name = "bst_ctr_aes_128_dma";
		break;
	case CRYPTO_BST_AES128_CBC_MAC:
		skciper_name = "bst_cbc_mac_aes_128_dma";
		break;
	case CRYPTO_BST_AES128_CMAC:
		skciper_name = "bst_cmac_aes_128_dma";
		break;
	case CRYPTO_BST_SM4_CBC:
		skciper_name = "bst_cbc_sm4_dma";
		break;
	case CRYPTO_BST_SM4_ECB:
		skciper_name = "bst_ecb_sm4_dma";
		break;
	case CRYPTO_BST_SM4_CTR:
		skciper_name = "bst_ctr_sm4_dma";
		break;
	case CRYPTO_BST_SM4_CFB:
		skciper_name = "bst_cfb_sm4_dma";
		break;
	case CRYPTO_BST_SM4_OFB:
		skciper_name = "bst_ofb_sm4_dma";
		break;
	case CRYPTO_BST_SM4_XTS:
		skciper_name = "bst_xts_sm4_dma";
		break;
	case CRYPTO_BST_SM4_CBC_MAC:
		skciper_name = "bst_cbc_mac_sm4_dma";
		break;
	case CRYPTO_BST_SM4_CMAC:
		skciper_name = "bst_cmac_sm4_dma";
		break;
	case CRYPTO_BST_DES_ECB:
		skciper_name = "bst_ecb_des_dma";
		break;
	case CRYPTO_BST_DES_CBC:
		skciper_name = "bst_cbc_des_dma";
		break;
	case CRYPTO_BST_DES_CFB:
		skciper_name = "bst_cfb_des_dma";
		break;
	case CRYPTO_BST_DES_OFB:
		skciper_name = "bst_ofb_des_dma";
		break;
	case CRYPTO_BST_DES_CTR:
		skciper_name = "bst_ctr_des_dma";
		break;
	case CRYPTO_BST_DES_CBC_MAC:
		skciper_name = "bst_cbc_mac_des_dma";
		break;
	case CRYPTO_BST_DES_CMAC:
		skciper_name = "bst_cmac_des_dma";
		break;
	case CRYPTO_BST_TDES128_ECB:
		skciper_name = "bst_ecb_tdes_128_dma";
		break;
	case CRYPTO_BST_TDES128_CBC:
		skciper_name = "bst_cbc_tdes_128_dma";
		break;
	case CRYPTO_BST_TDES128_CFB:
		skciper_name = "bst_cfb_tdes_128_dma";
		break;
	case CRYPTO_BST_TDES128_OFB:
		skciper_name = "bst_ofb_tdes_128_dma";
		break;
	case CRYPTO_BST_TDES128_CTR:
		skciper_name = "bst_ctr_tdes_128_dma";
		break;
	case CRYPTO_BST_TDES128_CBC_MAC:
		skciper_name = "bst_cbc_mac_tdes_128_dma";
		break;
	case CRYPTO_BST_TDES128_CMAC:
		skciper_name = "bst_cmac_tdes_128_dma";
		break;
	case CRYPTO_BST_TDES192_ECB:
		skciper_name = "bst_ecb_tdes_192_dma";
		break;
	case CRYPTO_BST_TDES192_CBC:
		skciper_name = "bst_cbc_tdes_192_dma";
		break;
	case CRYPTO_BST_TDES192_CFB:
		skciper_name = "bst_cfb_tdes_192_dma";
		break;
	case CRYPTO_BST_TDES192_OFB:
		skciper_name = "bst_ofb_tdes_192_dma";
		break;
	case CRYPTO_BST_TDES192_CTR:
		skciper_name = "bst_ctr_tdes_192_dma";
		break;
	case CRYPTO_BST_TDES192_CBC_MAC:
		skciper_name = "bst_cbc_mac_tdes_192_dma";
		break;
	case CRYPTO_BST_TDES192_CMAC:
		skciper_name = "bst_cmac_tdes_192_dma";
		break;
	case CRYPTO_BST_AES256_ECB_CPU:
		skciper_name = "bst_ecb_aes_256";
		break;
	case CRYPTO_BST_AES256_XTS_CPU:
		skciper_name = "bst_xts_aes_256";
		break;
	case CRYPTO_BST_AES256_CBC_CPU:
		skciper_name = "bst_cbc_aes_256";
		break;
	case CRYPTO_BST_AES256_CFB_CPU:
		skciper_name = "bst_cfb_aes_256";
		break;
	case CRYPTO_BST_AES256_OFB_CPU:
		skciper_name = "bst_ofb_aes_256";
		break;
	case CRYPTO_BST_AES256_CTR_CPU:
		skciper_name = "bst_ctr_aes_256";
		break;
	case CRYPTO_BST_AES256_CBC_MAC_CPU:
		skciper_name = "bst_cbc_mac_aes_256";
		break;
	case CRYPTO_BST_AES256_CMAC_CPU:
		skciper_name = "bst_cmac_aes_256";
		break;
	case CRYPTO_BST_AES192_ECB_CPU:
		skciper_name = "bst_ecb_aes_192";
		break;
	case CRYPTO_BST_AES192_XTS_CPU:
		skciper_name = "bst_xts_aes_192";
		break;
	case CRYPTO_BST_AES192_CBC_CPU:
		skciper_name = "bst_cbc_aes_192";
		break;
	case CRYPTO_BST_AES192_CFB_CPU:
		skciper_name = "bst_cfb_aes_192";
		break;
	case CRYPTO_BST_AES192_OFB_CPU:
		skciper_name = "bst_ofb_aes_192";
		break;
	case CRYPTO_BST_AES192_CTR_CPU:
		skciper_name = "bst_ctr_aes_192";
		break;
	case CRYPTO_BST_AES192_CBC_MAC_CPU:
		skciper_name = "bst_cbc_mac_aes_192";
		break;
	case CRYPTO_BST_AES192_CMAC_CPU:
		skciper_name = "bst_cmac_aes_192";
		break;
	case CRYPTO_BST_AES128_ECB_CPU:
		skciper_name = "bst_ecb_aes_128";
		break;
	case CRYPTO_BST_AES128_XTS_CPU:
		skciper_name = "bst_xts_aes_128";
		break;
	case CRYPTO_BST_AES128_CBC_CPU:
		skciper_name = "bst_cbc_aes_128";
		break;
	case CRYPTO_BST_AES128_CFB_CPU:
		skciper_name = "bst_cfb_aes_128";
		break;
	case CRYPTO_BST_AES128_OFB_CPU:
		skciper_name = "bst_ofb_aes_128";
		break;
	case CRYPTO_BST_AES128_CTR_CPU:
		skciper_name = "bst_ctr_aes_128";
		break;
	case CRYPTO_BST_AES128_CBC_MAC_CPU:
		skciper_name = "bst_cbc_mac_aes_128";
		break;
	case CRYPTO_BST_AES128_CMAC_CPU:
		skciper_name = "bst_cmac_aes_128";
		break;
	case CRYPTO_BST_SM4_CBC_CPU:
		skciper_name = "bst_cbc_sm4";
		break;
	case CRYPTO_BST_SM4_ECB_CPU:
		skciper_name = "bst_ecb_sm4";
		break;
	case CRYPTO_BST_SM4_CTR_CPU:
		skciper_name = "bst_ctr_sm4";
		break;
	case CRYPTO_BST_SM4_CFB_CPU:
		skciper_name = "bst_cfb_sm4";
		break;
	case CRYPTO_BST_SM4_OFB_CPU:
		skciper_name = "bst_ofb_sm4";
		break;
	case CRYPTO_BST_SM4_XTS_CPU:
		skciper_name = "bst_xts_sm4";
		break;
	case CRYPTO_BST_SM4_CBC_MAC_CPU:
		skciper_name = "bst_cbc_mac_sm4";
		break;
	case CRYPTO_BST_SM4_CMAC_CPU:
		skciper_name = "bst_cmac_sm4";
		break;
	case CRYPTO_BST_DES_ECB_CPU:
		skciper_name = "bst_ecb_des";
		break;
	case CRYPTO_BST_DES_CBC_CPU:
		skciper_name = "bst_cbc_des";
		break;
	case CRYPTO_BST_DES_CFB_CPU:
		skciper_name = "bst_cfb_des";
		break;
	case CRYPTO_BST_DES_OFB_CPU:
		skciper_name = "bst_ofb_des";
		break;
	case CRYPTO_BST_DES_CTR_CPU:
		skciper_name = "bst_ctr_des";
		break;
	case CRYPTO_BST_DES_CBC_MAC_CPU:
		skciper_name = "bst_cbc_mac_des";
		break;
	case CRYPTO_BST_DES_CMAC_CPU:
		skciper_name = "bst_cmac_des";
		break;
	case CRYPTO_BST_TDES128_ECB_CPU:
		skciper_name = "bst_ecb_tdes_128";
		break;
	case CRYPTO_BST_TDES128_CBC_CPU:
		skciper_name = "bst_cbc_tdes_128";
		break;
	case CRYPTO_BST_TDES128_CFB_CPU:
		skciper_name = "bst_cfb_tdes_128";
		break;
	case CRYPTO_BST_TDES128_OFB_CPU:
		skciper_name = "bst_ofb_tdes_128";
		break;
	case CRYPTO_BST_TDES128_CTR_CPU:
		skciper_name = "bst_ctr_tdes_128";
		break;
	case CRYPTO_BST_TDES128_CBC_MAC_CPU:
		skciper_name = "bst_cbc_mac_tdes_128";
		break;
	case CRYPTO_BST_TDES128_CMAC_CPU:
		skciper_name = "bst_cmac_tdes_128";
		break;
	case CRYPTO_BST_TDES192_ECB_CPU:
		skciper_name = "bst_ecb_tdes_192";
		break;
	case CRYPTO_BST_TDES192_CBC_CPU:
		skciper_name = "bst_cbc_tdes_192";
		break;
	case CRYPTO_BST_TDES192_CFB_CPU:
		skciper_name = "bst_cfb_tdes_192";
		break;
	case CRYPTO_BST_TDES192_OFB_CPU:
		skciper_name = "bst_ofb_tdes_192";
		break;
	case CRYPTO_BST_TDES192_CTR_CPU:
		skciper_name = "bst_ctr_tdes_192";
		break;
	case CRYPTO_BST_TDES192_CBC_MAC_CPU:
		skciper_name = "bst_cbc_mac_tdes_192";
		break;
	case CRYPTO_BST_TDES192_CMAC_CPU:
		skciper_name = "bst_cmac_tdes_192";
		break;
	default:
		derr(1, "bad cipher: %d", sop->cipher);
		return -EINVAL;
	}
	...
	case CRYPTO_SHA2_512_HMAC:
		...
		break;
	case CRYPTO_SM3_HMAC:
		hash_name = "hmac(sm3)";
		break;
	case CRYPTO_BST_SHA256_HMAC:
		hash_name = "bst_hmac_sha256_dma";
		break;
	case CRYPTO_BST_SHA224_HMAC:
		hash_name = "bst_hmac_sha224_dma";
		break;
	case CRYPTO_BST_SHA512_HMAC:
		hash_name = "bst_hmac_sha512_dma";
		break;
	case CRYPTO_BST_SHA512_224_HMAC:
		hash_name = "bst_hmac_sha512_224";
		break;
	case CRYPTO_BST_SHA512_256_HMAC:
		hash_name = "bst_hmac_sha512_256";
		break;
	case CRYPTO_BST_SHA1_HMAC:
		hash_name = "bst_hmac_sha1_dma";
		break;
	case CRYPTO_BST_MD5_HMAC:
		hash_name = "bst_hmac_md5_dma";
		break;
	case CRYPTO_BST_SM3_HMAC:
		hash_name = "bst_hmac_sm3_dma";
		break;

	case CRYPTO_BST_SHA256_HMAC_CPU:
		hash_name = "bst_hmac_sha256";
		break;
	case CRYPTO_BST_SHA224_HMAC_CPU:
		hash_name = "bst_hmac_sha224";
		break;
	case CRYPTO_BST_SHA512_HMAC_CPU:
		hash_name = "bst_hmac_sha512";
		break;
	case CRYPTO_BST_SHA512_224_HMAC_CPU:
		hash_name = "bst_hmac_sha512_224";
		break;
	case CRYPTO_BST_SHA512_256_HMAC_CPU:
		hash_name = "bst_hmac_sha512_256";
		break;
	case CRYPTO_BST_SHA1_HMAC_CPU:
		hash_name = "bst_hmac_sha1";
		break;
	case CRYPTO_BST_MD5_HMAC_CPU:
		hash_name = "bst_hmac_md5";
		break;
	case CRYPTO_BST_SM3_HMAC_CPU:
		hash_name = "bst_hmac_sm3";
		break;
	...
	case CRYPTO_SM3:
		...
		break;
	case CRYPTO_BST_SM3:
		hash_name = "bst_sm3_dma";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_MD5:
		hash_name = "bst_md5_dma";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA256:
		hash_name = "bst_sha256_dma";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA1:
		hash_name = "bst_sha1_dma";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA224:
		hash_name = "bst_sha224_dma";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA512:
		hash_name = "bst_sha512_dma";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA512_224:
		hash_name = "bst_sha512_224";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA512_256:
		hash_name = "bst_sha512_256";
		hmac_mode = 0;
		break;

	case CRYPTO_BST_SM3_CPU:
		hash_name = "bst_sm3";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_MD5_CPU:
		hash_name = "bst_md5";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA256_CPU:
		hash_name = "bst_sha256";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA1_CPU:
		hash_name = "bst_sha1";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA224_CPU:
		hash_name = "bst_sha224";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA512_CPU:
		hash_name = "bst_sha512";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA512_224_CPU:
		hash_name = "bst_sha512_224";
		hmac_mode = 0;
		break;
	case CRYPTO_BST_SHA512_256_CPU:
		hash_name = "bst_sha512_256";
		hmac_mode = 0;
		break;
	default:
		derr(1, "bad mac: %d", sop->mac);
		return -EINVAL;
	}
	...
	if (skciper_name || akciper_name) {
		unsigned int keylen;
		ret = cryptodev_get_cipher_keylen(&keylen, sop, aead);
		if (unlikely(ret < 0)) {
			derr(1, "Setting ciphekey failed for %s-%zu.",
				skciper_name, (size_t)sop->keylen*8);
			goto session_error;
		}
		...
		if(skciper_name){
			ret = cryptodev_skcipher_init(&ses_new->cdata, skciper_name, keys.ckey,
						keylen, stream, aead);
			if (ret < 0) {
				derr(1, "Failed to load skcipher for %s", skciper_name);
				ret = -EINVAL;
				goto session_error;
			...
			ret = cryptodev_akcipher_init(&ses_new->cdata, akciper_name, keys.ckey,
						keylen, sop->kop);
			if (ret < 0) {
				derr(1, "Failed to load akcipher for %s", akciper_name);
				ret = -EINVAL;
				goto session_error;
	...
	if (hash_name && aead == 0) {
		if (unlikely(sop->mackeylen > CRYPTO_HMAC_MAX_KEY_LEN)) {
			derr(1, "Setting mackey failed for %s-%zu.",
		...
		if (ret != 0) {
			derr(1, "Failed to load hash for %s", hash_name);
			ret = -EINVAL;
			goto session_error;
		}
	...
	//derr(2, "got alignmask %d", ses_new->alignmask);

	ses_new->array_size = DEFAULT_PREALLOC_PAGES;
	//derr(2, "preallocating for %d user pages", ses_new->array_size);
...
static int get_session_info(struct fcrypt *fcr, struct session_info_op *siop)
{
	...
	if (ses_ptr->cdata.init) {
		if (ses_ptr->cdata.aead == 0 && ses_ptr->cdata.akcipher == 0)
			tfm = cryptodev_crypto_blkcipher_tfm(ses_ptr->cdata.async.s);
		else if (ses_ptr->cdata.aead == 0 && ses_ptr->cdata.akcipher == 1)
			tfm = crypto_akcipher_tfm(ses_ptr->cdata.async.ak);
		else
