...
#define CRYPTO_CIPHER_MAX_KEY_LEN	1200
...
enum cryptodev_crypto_op_t {
	...
	CRYPTO_BST_SHA224,
	CRYPTO_BST_SHA512,
	CRYPTO_BST_SHA512_224,
	CRYPTO_BST_SHA512_256,
	CRYPTO_BST_SHA256_HMAC,
	CRYPTO_BST_SHA224_HMAC,
	CRYPTO_BST_SHA512_HMAC,
	CRYPTO_BST_SHA512_224_HMAC,
	CRYPTO_BST_SHA512_256_HMAC,
	CRYPTO_BST_SHA1_HMAC,
	CRYPTO_BST_MD5_HMAC,
	CRYPTO_BST_SM3_HMAC,
	CRYPTO_BST_AES256_ECB,
	CRYPTO_BST_AES256_XTS,
	CRYPTO_BST_AES256_CBC,
	CRYPTO_BST_AES256_CFB,
	CRYPTO_BST_AES256_OFB,
	CRYPTO_BST_AES256_CTR,
	CRYPTO_BST_AES256_CBC_MAC,
	CRYPTO_BST_AES256_CMAC,
	CRYPTO_BST_AES192_ECB,
	CRYPTO_BST_AES192_XTS,
	CRYPTO_BST_AES192_CBC,
	CRYPTO_BST_AES192_CFB,
	CRYPTO_BST_AES192_OFB,
	CRYPTO_BST_AES192_CTR,
	CRYPTO_BST_AES192_CBC_MAC,
	CRYPTO_BST_AES192_CMAC,
	CRYPTO_BST_AES128_ECB,
	CRYPTO_BST_AES128_XTS,
	CRYPTO_BST_AES128_CBC,
	CRYPTO_BST_AES128_CFB,
	CRYPTO_BST_AES128_OFB,
	CRYPTO_BST_AES128_CTR,
	CRYPTO_BST_AES128_CBC_MAC,
	CRYPTO_BST_AES128_CMAC,
	CRYPTO_BST_SM4_CBC,
	CRYPTO_BST_SM4_ECB,
	CRYPTO_BST_SM4_CTR,
	CRYPTO_BST_SM4_CFB,
	...
	CRYPTO_BST_DES_OFB,
	CRYPTO_BST_DES_CTR,
	CRYPTO_BST_DES_CBC_MAC,
	CRYPTO_BST_DES_CMAC,
	CRYPTO_BST_TDES128_ECB,
	CRYPTO_BST_TDES128_CBC,
	CRYPTO_BST_TDES128_CFB,
	CRYPTO_BST_TDES128_OFB,
	CRYPTO_BST_TDES128_CTR,
	CRYPTO_BST_TDES128_CBC_MAC,
	CRYPTO_BST_TDES128_CMAC,
	CRYPTO_BST_TDES192_ECB,
	CRYPTO_BST_TDES192_CBC,
	CRYPTO_BST_TDES192_CFB,
	CRYPTO_BST_TDES192_OFB,
	CRYPTO_BST_TDES192_CTR,
	CRYPTO_BST_TDES192_CBC_MAC,
	CRYPTO_BST_TDES192_CMAC,
	CRYPTO_BST_RSA,
	CRYPTO_BST_SM2,
	CRYPTO_BST_ECDSA,
	...
	CRYPTO_BST_SM3_CPU,
	CRYPTO_BST_MD5_CPU,
	CRYPTO_BST_SHA256_CPU,
	CRYPTO_BST_SHA1_CPU,
	CRYPTO_BST_SHA224_CPU,
	CRYPTO_BST_SHA512_CPU,
	CRYPTO_BST_SHA512_224_CPU,
	CRYPTO_BST_SHA512_256_CPU,
	CRYPTO_BST_SHA256_HMAC_CPU,
	CRYPTO_BST_SHA224_HMAC_CPU,
	CRYPTO_BST_SHA512_HMAC_CPU,
	CRYPTO_BST_SHA512_224_HMAC_CPU,
	CRYPTO_BST_SHA512_256_HMAC_CPU,
	CRYPTO_BST_SHA1_HMAC_CPU,
	CRYPTO_BST_MD5_HMAC_CPU,
	CRYPTO_BST_SM3_HMAC_CPU,
	CRYPTO_BST_AES256_ECB_CPU,
	CRYPTO_BST_AES256_XTS_CPU,
	CRYPTO_BST_AES256_CBC_CPU,
	CRYPTO_BST_AES256_CFB_CPU,
	CRYPTO_BST_AES256_OFB_CPU,
	CRYPTO_BST_AES256_CTR_CPU,
	CRYPTO_BST_AES256_CBC_MAC_CPU,
	CRYPTO_BST_AES256_CMAC_CPU,
	CRYPTO_BST_AES192_ECB_CPU,
	CRYPTO_BST_AES192_XTS_CPU,
	CRYPTO_BST_AES192_CBC_CPU,
	CRYPTO_BST_AES192_CFB_CPU,
	CRYPTO_BST_AES192_OFB_CPU,
	CRYPTO_BST_AES192_CTR_CPU,
	CRYPTO_BST_AES192_CBC_MAC_CPU,
	CRYPTO_BST_AES192_CMAC_CPU,
	CRYPTO_BST_AES128_ECB_CPU,
	CRYPTO_BST_AES128_XTS_CPU,
	CRYPTO_BST_AES128_CBC_CPU,
	CRYPTO_BST_AES128_CFB_CPU,
	CRYPTO_BST_AES128_OFB_CPU,
	CRYPTO_BST_AES128_CTR_CPU,
	CRYPTO_BST_AES128_CBC_MAC_CPU,
	CRYPTO_BST_AES128_CMAC_CPU,
	CRYPTO_BST_SM4_CBC_CPU,
	CRYPTO_BST_SM4_ECB_CPU,
	CRYPTO_BST_SM4_CTR_CPU,
	CRYPTO_BST_SM4_CFB_CPU,
	CRYPTO_BST_SM4_OFB_CPU,
	CRYPTO_BST_SM4_XTS_CPU,
	CRYPTO_BST_SM4_CBC_MAC_CPU,
	CRYPTO_BST_SM4_CMAC_CPU,
	CRYPTO_BST_DES_ECB_CPU,
	CRYPTO_BST_DES_CBC_CPU,
	CRYPTO_BST_DES_CFB_CPU,
	CRYPTO_BST_DES_OFB_CPU,
	CRYPTO_BST_DES_CTR_CPU,
	CRYPTO_BST_DES_CBC_MAC_CPU,
	CRYPTO_BST_DES_CMAC_CPU,
	CRYPTO_BST_TDES128_ECB_CPU,
	CRYPTO_BST_TDES128_CBC_CPU,
	CRYPTO_BST_TDES128_CFB_CPU,
	CRYPTO_BST_TDES128_OFB_CPU,
	CRYPTO_BST_TDES128_CTR_CPU,
	CRYPTO_BST_TDES128_CBC_MAC_CPU,
	CRYPTO_BST_TDES128_CMAC_CPU,
	CRYPTO_BST_TDES192_ECB_CPU,
	CRYPTO_BST_TDES192_CBC_CPU,
	CRYPTO_BST_TDES192_CFB_CPU,
	CRYPTO_BST_TDES192_OFB_CPU,
	CRYPTO_BST_TDES192_CTR_CPU,
	CRYPTO_BST_TDES192_CBC_MAC_CPU,
	CRYPTO_BST_TDES192_CMAC_CPU,
	CRYPTO_BST_RSA_CPU,
	CRYPTO_BST_SM2_CPU,
	CRYPTO_BST_ECDSA_CPU,
...
struct session_op {
	...
	__u32	akcipher;		/* cryptodev_crypto_op_t */
	__u32	mac;		/* cryptodev_crypto_op_t */
	__u32	kop;		/* cryptodev_crypto_setkey_op_t */
...
#define COP_SET_KEY 0
#define COP_SET_PUBKEY 1
